...
/**
 * The Brief stage derivation, under vitest so CI runs it.
 *
 * The cases themselves live in brief-intake.cases.ts, shared with the tsx runner
...
const cases = collectBriefIntakeCases();

describe("brief-intake derivation", () => {
