...
export const GetAssetsResponseItem = zod.object({
  ...
  approvedChannels: zod.array(zod.string()).nullish(),
  approvedTemplates: zod.array(zod.string()).nullish(),
  subjectIdentityScore: zod.number().nullish(),
  styleStrengthScore: zod.number().nullish(),
  compositingOnly: zod.boolean().nullish(),
  generationAllowed: zod.boolean().nullish(),
  approvedForCompositing: zod.boolean().nullish(),
  referencePriorityDefault: zod.number().nullish(),
  conflictTags: zod.array(zod.string()).nullish(),
  freshnessScore: zod.number().nullish(),
  fontWeight: zod.string().nullish(),
  fontName: zod.string().nullish(),
  createdAt: zod.date(),
  updatedAt: zod.date(),
});
