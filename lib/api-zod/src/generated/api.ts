...
export const GetAssetsResponseItem = zod.object({
  ...
  subjectIdentityScore: zod.number(),
  styleStrengthScore: zod.number(),
  compositingOnly: zod.boolean(),
  generationAllowed: zod.boolean(),
  approvedForCompositing: zod.boolean(),
  referencePriorityDefault: zod.number(),
...
export const UpdateAssetBody = zod.object({
  ...
  generationAllowed: zod.boolean().optional(),
  approvedForCompositing: zod.boolean().optional(),
  subjectIdentityScore: zod.number().optional(),
  styleStrengthScore: zod.number().optional(),
  referencePriorityDefault: zod.number().optional(),
